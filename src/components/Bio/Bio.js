                    ...
                    <div className="column-2"></div>
                        <div className="column-8">      
                             <h3 className="greeting">Hi, I'm Lars!</h3>
                               ...
                               <p className="bio-text">I love freelance projects, whether in learning design or web development. I've built websites for small businesses, professional websites for freelancers and academics, web applications to help people manage tedious daily tasks, and interactive educational resources for non-profit organizations. I am also working on my game design skills - for fun and for clients! If you are interested in working with me, <a href="mailto:larsmackenzie@gmail.com">shoot me an email</a> to get the conversation started.</p>
