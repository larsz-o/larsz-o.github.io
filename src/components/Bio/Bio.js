                    ...
                    <div className="column-2"></div>
                        <div className="column-8">      
                             <h3 className="greeting">Hi, I'm Lars!</h3>
                               ...
                               <p className="bio-text">In this role, I work with instructors to develop project-based courses where students learn by doing. I strongly believe in collaborative, hands-on learning -- and that even the most technical of concepts can be taught through <span className="highlight">creativity</span> and <span className="highlight">experimentation</span>. Some highlights of my work include redesigning a course template used for twelve online graduate programs; developing a health and wellness training for all incoming first-year and transfer students; and building web applications for teaching and learning. I also lead my team's efforts to support faculty who want to use cloud services for their teaching, such as Amazon Web Services and GitHub.</p>
