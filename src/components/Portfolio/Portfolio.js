    ...
    constructor(props) {
        ...
        this.state = {
            projects: [
                ...
                { image: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/projects/adult-business-meeting-casual-2422282.jpg', title: 'Health and Wellness training', description: `I was brought on to design and implement a health and wellness online training which is completed by all incoming first-year and transfer students at Brandeis University. I worked with subject matter experts in the Health and Wellness Promotion Program to develop a 6 lesson training complete with pre- and post-assessments, lessons, comprehension checks, and resources. The training was built in Moodle.`, link: 'https://www.brandeis.edu/health/promotion/', demo: false },
                {image: 'https://unitygameslzm.s3.us-east-2.amazonaws.com/Screen+Shot+2020-02-01+at+2.57.25+PM.png', title: 'Block Breaker Game', description: `I developed this 5 level game to practice working with Unity and C#. The game is playable on a desktop web browser (not mobile-compatible).`, link: 'https://unitygameslzm.s3.us-east-2.amazonaws.com/blockbreaker/index.html', demo: true},
