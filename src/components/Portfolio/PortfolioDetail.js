    ...
    constructor(props) {
        ...
        this.state = {
            ...
            projects: [
                ...
                { title: 'Educational Technology Presentations', category_id: 1, images: [{ url: 'onlinelearning.png', link: 'https://docs.google.com/presentation/d/12-AUMqb8atbwgLkYcwJHq-0nfSn6jTpF8CHpKzl6kQM/edit?usp=sharing' }], description: 'There are some great ways to use educational technology to foster creative and engaged learning.' }
