    ...
    constructor(props) {
        ...
        this.state = {
            ...
            projects: [
                ...
                { title: 'Animated Video Production', category_id: 1, images: [{ url: 'intro-video.png', link: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/Course+introduction-1080p-c6b574a6-6193-4c7e-9958-586a24cbd397.mp4' }, {url: 'restructure.png', link: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/Restructuring+your+existing+content+-+reflection-1080p-e925e139-4549-44f2-882e-afd09f33a327.mp4'}], description: 'I created these videos for a self-paced course for faculty teaching online for the first time. I drafted the storyboards, wrote the script, recorded the narration, and designed the visual and audio elements.' },
                ...
                { title: 'Audio Visual Production Training', category_id: 4, images: [{ url: 'digitalstory.png', link: 'https://drive.google.com/open?id=1S7koWEpS9v0HfDMyQ_mNsD80uBW4LjpR' }, { url: 'maps.png', link: 'https://drive.google.com/file/d/1wqlLn1gD6rQV71KfgYhR4qmZvCsB65S1/view?usp=sharing' }], description: 'I have trained hundreds of students and dozens of faculty how to produce short video projects and narrative digital maps - from storyboarding to post-production.' },
                { title: 'Educational Technology Presentations', category_id: 1, images: [{ url: 'onlinelearning.png', link: 'https://docs.google.com/presentation/d/12-AUMqb8atbwgLkYcwJHq-0nfSn6jTpF8CHpKzl6kQM/edit?usp=sharing' }], description: 'There are some great ways to use educational technology to foster creative and engaged learning. Check out this presentation I gave about how online peer presentations can help build student confidence and be a site of rich, engaged learning.' },
