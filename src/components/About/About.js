                    ...
                    {isDesktop ? (<Row>
                        ...
                        <Col xs={12} md={6} lg={6}>
                            <ul className="about-text">
                                ...
                                <li>I get to do a lot of cool stuff like launch AWS environments for software engineering courses, build web apps to make our information delivery more efficient, and help online instructors make their courses more interactive, well-designed, and intuitive to use</li>
