                    ...
                    <div className="column-2"></div>
                        <div className="column-8">      
                             <h3 className="greeting">Hi, I'm Lars!</h3>
                                <p>I'm a learning experience designer and full-stack web developer based in the Greater Boston area. I currently <a href="https://www.linkedin.com/in/lars-mackenzie/" target="_blank" rel="noopener noreferrer">work</a> building online educational experiences at Brandeis University. I provide consultations to faculty about using technology in their teaching: from helping them select appropriate tools for any given task to building complete educational environments. I am driven by my commitments to usability, critical thinking, scalability, and accessibility when developing student learning experiences. </p>    
