            ...
            <section className="main">
                ...
                <Grid>
                    ...
                    <Row>
                        ...
                        <Row>
                            <Col xs={12} md={6} lg={6}>
                                <h3>For the past six years, I've been pursuing a PhD at the University of Minnesota, where I studied how software and data-driven decision-making impact marginalized people. Specifically, I closely examined civil rights implications resulting from big data surveillance in healthcare, financial industries, and law.</h3>
                            </Col>
                        </Row>
                        <Row>
                        <div className="row-padding"></div>
                        ...
                        <Row>
                            <Col xs={12} md={6} lg={6}>
                                <h3>During that time, I was deeply involved with educational technology: helping faculty to integrate digital technology into their research and teaching, and training students to produce digital media projects.</h3>
                            </Col>
                        </Row>
                        <Row>
                        <div className="row-padding"></div>
                    ...
                    <Row>
                            <Col xs={12} md={6} lg={6}>
                            <h3> I've tackled big problems in this work, like figuring out how to <span className="emphasis">archive hundreds of student-made video projects while protecting their privacy,</span> or how to best highlight research insights from qualitative studies in <span className="emphasis">narrative digital maps.</span></h3>
                            </Col>
                        </Row>
                        <Row>
                        <div className="row-padding"></div>
