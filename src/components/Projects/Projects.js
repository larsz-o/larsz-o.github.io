...
class Projects extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            {title: 'Dinner Diary', url: 'https://cryptic-bastion-11483.herokuapp.com/#/', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/Screen+Shot+2019-09-30+at+2.09.29+PM.png', img_desc: 'header for Dinner Diary', description: 'I create this web app to practice using Redux. The application guides the user through a series of questions about the dinner they ate and collects the data along the way in a Redux store. The user can keep track of their favorite meals using this tool and sort the log to determine which meals were best ranked.'},
            {title: 'Our Pets', url: '/#/404', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/french-bulldog-4480149_640.jpg', img_desc: 'screenshot of Our Pets', description: 'A mobile-friendly full-stack web application that helps households keep track of daily pet care. Users can mark when pets have been fed, walked, or given medications, which will send a text message alert to other caregivers in their household. Not sure if your dog has been fed or if he is just begging? Never be tricked again with Our Pets!'},
            {title: 'Is David Schwimmer Alive?', url: 'https://afternoon-scrubland-12147.herokuapp.com/', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/David_Schwimmer_Jul_2005_London%2C_England_Crop%26blur.jpg', img_desc: 'David Schwimmer', description: 'A 90\'s\ style web app that checks the Wikipedia API to see if David Schwimmer is still alive or not. This page also contains a random quote generator where users can find quotes from David Schwimmer or Ross Gellar. You can add your own contributions, too!'}
        ],
            ...
            {title: 'Cataloguing and Digital Asset Management', url: '', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/featured1.svg', img_desc: 'database icon', description: 'I have contributed to archival projects by writing abstracts for an oral history archive and collaborating to define metadata schemas for hundreds of digital assets. I have also been responsible for processing digital media assets and monitoring data storage on long-term projects.'}
        ],
            selected: '',
        }
    }
