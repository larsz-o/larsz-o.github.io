...
class Projects extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            { title: 'Fitness Session Tracker', url: 'https://stormy-citadel-76866.herokuapp.com/#/', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/Screen+Shot+2019-10-16+at+1.57.47+PM.png', img_desc: 'Fitness Meets Wellness logo', description: 'I built the Fitness Session Tracker for a personal trainer who was looking for an easier and less awkward way to remind her clients to pay her for their sessions. This web app allows the trainer to track how many sessions a client has paid for and track when sessions are used. When a client has 3 or fewer prepaid sessions remaining, the trainer is prompted to email the client a pre-drafted reminder to bring payment the next time they come in for a session. Email reminders are sent using the Google Mail API through Node.' },
