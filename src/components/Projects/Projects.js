...
class Projects extends Component {
    constructor(props) {
        ...
        this.state = {
            menu: true,
            web: [
            { title: 'Fitness Session Tracker', url: 'https://stormy-citadel-76866.herokuapp.com/#/', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/fmwview.png', img_desc: 'Fitness Meets Wellness logo', description: 'I built the Fitness Session Tracker for a personal trainer who was looking for an easier and less awkward way to remind her clients to pay her for their sessions. This web app allows the trainer to track how many sessions a client has paid for and track when sessions are used. When a client has 3 or fewer prepaid sessions remaining, the trainer is prompted to email the client a pre-drafted reminder to bring payment the next time they come in for a session. Email reminders are sent using the Google Mail API through Node.' },
            ...
            {title: 'Digital Learning Design Lab', url:'http://blogs.brandeis.edu/instructionaldesign/', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/teachinglab.png', img_desc: 'Digital Teaching Innovation Lab logo', description: 'I built a website for the instructional design team at Brandeis University using WordPress. I was responsible for determining the sitemap, layout, and design. I created the design from scratch using custom CSS throughout. Building a site like this for my team (all non-developers besdies me) entailed making sure that it could be maintained by anyone but still have a unique and branded look and feel. The site is still a work-in-progress, but feel free to check it out in its beta stage.'}, 
            {title: 'Minnesota Youth Story Squad', url: 'http://youthstorysquad.org', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/Screen+Shot+2019-09-30+at+11.09.05+AM.png', img_desc: 'header for MYSS site', description: 'I worked with the MYSS project to build and maintain their WordPress site over two years. MYSS is the public repository for a project that amplifies the voices of middle-school students in the Twin Cities, teaching students to create digital stories with a social justice focus. I helped MYSS by creating a website that could be easily maintained by the founders to showcase these important stories.'},{title: 'Dinner Diary', url: 'https://cryptic-bastion-11483.herokuapp.com/#/', img: 'https://lars-prof-site.s3.us-east-2.amazonaws.com/Screen+Shot+2019-09-30+at+2.09.29+PM.png', img_desc: 'header for Dinner Diary', description: 'I created this web app to practice using Redux. The application guides the user through a series of questions about the dinner they ate and collects the data along the way in a Redux store. The user can keep track of their favorite meals using this tool and sort the log to determine which meals were best ranked.'},
